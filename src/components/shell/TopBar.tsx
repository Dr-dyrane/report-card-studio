...
export function TopBar() {
  ...
  return (
    <header className="app-topbar sticky top-0 z-[var(--z-topbar)] overflow-visible px-0 pt-0 sm:px-1 pt-1 xl:px-0">
      <div className="frost-panel premium-wash premium-sheen mx-0 flex items-center justify-between gap-3 overflow-visible rounded-none px-2 py-3 sm:flex-wrap sm:gap-4 sm:rounded-[28px] sm:px-4 sm:py-4 xl:px-8">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:flex-wrap sm:gap-3">
          ...
          {currentUser ? (
            <Link
              href="/profile"
              className="surface-chip hidden items-center gap-2 rounded-full px-3 py-2 sm:inline-flex"
            >
              <UserAvatar
                name={currentUser.name}
                username={currentUser.username}
